...
lyr_ClubhouseLocations_5.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_ElementarySchoolDistricts_3.set('fieldImages', {'Name': 'TextEdit', 'description': 'Hidden', 'timestamp': 'Hidden', 'begin': 'Hidden', 'end': 'Hidden', 'altitudeMode': 'Hidden', 'tessellate': 'Hidden', 'extrude': 'Hidden', 'visibility': 'Range', 'drawOrder': 'Hidden', 'icon': 'Hidden', });
...
lyr_RenterOccupiedUnits_2.set('fieldLabels', {'renter_occ': 'no label', });
lyr_ElementarySchoolDistricts_3.set('fieldLabels', {'Name': 'header label', 'visibility': 'no label', });
